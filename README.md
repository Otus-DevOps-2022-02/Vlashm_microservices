...
Инструкция к ДЗ устарела очень

- Установлен *Helm*
- Созданы чарты для приложения
- Созданы *_helpers.tpl* для сервисов *UI*, *POST* и *COMMENT*
- В кластер *Kubernetes* установлен и настроен *Gitlab*
- Для сервисов написаны пайплайны

### Задание со *

Для связки пайплайнов используются триггеры *gitlab*
